...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--path', help='Path the file is in', default='pmb/videos/')
    parser.add_argument('-o', '--output', help='Path the file result should be saved', default='pmb/result/')
